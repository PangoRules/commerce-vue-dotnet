...
public class CategoryConfiguration : IEntityTypeConfiguration<Category>
{
    public void Configure(EntityTypeBuilder<Category> builder)
    {
        ...
        builder.HasData(
            new Category { Id = 1, Name = "Electronics", Description = "Electronic gadgets and devices", CreatedAt = seedDate, IsActive = true, IsFeatured = true },
            new Category { Id = 2, Name = "Books", Description = "Various kinds of books and literature", CreatedAt = seedDate, IsActive = true },
            new Category { Id = 3, Name = "Home & Kitchen", Description = "Appliances and tools for home and kitchen", CreatedAt = seedDate, IsActive = true, IsFeatured = true },
            new Category { Id = 4, Name = "Clothing", Description = "Men's and women's apparel", CreatedAt = seedDate, IsActive = true, IsFeatured = true },
            new Category { Id = 5, Name = "Sports & Outdoors", Description = "Sports gear and outdoor equipment", CreatedAt = seedDate, IsActive = true },

            // Shared nodes (will use default IsFeatured = false)
